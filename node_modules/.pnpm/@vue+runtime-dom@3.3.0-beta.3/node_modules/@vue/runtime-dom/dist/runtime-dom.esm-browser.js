...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const mountElement = (vnode, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) => {
    ...
    if (parentComponent && !parentComponent.isAddedCEChildStyle && parentComponent.parent && // If the parent component is wrapped by an defineAsyncComponent function,
    // it will not be processed
    !parentComponent.parent.type.__asyncLoader) {
      const styles = parentComponent.isCEChild && parentComponent.type.styles || null;
